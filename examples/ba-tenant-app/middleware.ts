...
// The Better Auth session cookie base name in a secure (HTTPS) deployment.
// Intent matches getBetterAuthCookieName({ secure: true }); the value is inlined
// here because middleware must stay crypto-free (no package-root import). Presence
